...
public class EvaluateBean {
	...
	public String toString() {
		return "EvaluateBean [gid=" + gid + ", oid=" + oid + ", egrade_4=" + egrade_4 + ", grade=" + grade + ", amount="
				+ amount + ", uaccounts=" + uaccounts + ", hidename=" + hidename + ", uheadimg=" + uheadimg + ", temp1="
				+ temp1 + ", econtent=" + econtent + ", gtitle1=" + gtitle1 + "]";
	}
