...
<body>
	...
	<div id="content">
		<div class="nav">
			<a class="black__green" href="">衡阳团购</a> <span>»</span> <a
				class="black__green" href="">美食团购</a> <span>»</span> <a
				class="black__green" href="">火锅</a> <span>»</span> <a
				class="black__green" href="">蒸湘区</a> <span>»</span> <a
				class="black__green" href="">星美/美凯龙</a> <span>»</span> <span
				id="foodTitle1"></span>
		</div>
		<!--nav-->
		<div id="body_mid1">
			<div id="body_midl_top">
				<div id="body_mid1_top1">
					<input type="hidden" value="" class="get_id" /> <span
						class="title-prefix"></span>
					<h1 class="title"></h1>
				</div>
				...
				<div id="down_right">
					<div id="price">
						<div class="price_cf ">
							...
							<h2 class="symbol">
								<span class="price-symbol">¥</span> <span class="price">39</span>
							</h2>
							<span class="promote-default"> <span class="status">门店价</span>
					...
					<div id="evaluate">
						...
						<div id="item-viewed">
							<span class="item-viewed"><a id="look-normal"> <span
									class="rating-stars">3.9</span>分
							</a></span>
						</div>
						<div id="comments-count">
							<span class="comments-count"><a id="look-normal"> <span
									class="comment-count">8</span>人评价
							</a></span>
						</div>
					</div>
					<div id="data">
						<span class="detail-leading">有效期</span><span class="text-containe">
							<span class="valid-through">截止到 <span class="edate">2016.12.30</span>
						</span> <span class="expiry-notice">周末、法定节假日通用</span>
						</span>
					</div>
					<div id="package">
	...
	<div id="body_mid2">
		<div id="body_mid2_left">
			<table width="702" id="body_mid2_others">
				...
				<tr height="36px" class="other_tr1">
					<td class="other1_1">
						<p>
							<a href="#" class="other_1_a"> 【星美/美凯龙】秘制烤鱼，建议3-4人使用，包间免费 </a>
						</p>
					</td>
		...
		<div id="body_mid2_right">
			<a href="#"><img class="mid2_guanggao1"
				src="images/guanggao1.png" /></a> <a href="#"><img
				class="mid2_guanggao2" src="images/guanggao2.png" /></a>
		</div>
		<!--body_mid2_right-->
	</div>
	<!--body_mid2-->
	<div id="foods_introduce">
		...
		<div>
			...
			<div class="deal_buy">
				...
				<div>
					<input id="qianggou" type="submit" value="抢购"> <a
						id="join_cart" href="javascript:void(0)">加入购物车</a>
				</div>
		...
		<div id="beian">
			<div>
				<center>
					...
					<div>
						<a href=""><img src="basic_images/beian_1.png" /></a> <a href=""><img
							src="basic_images/beian_2.png" /></a> <a href=""><img
