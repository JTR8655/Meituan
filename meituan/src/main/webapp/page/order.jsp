...
<script>
	...
	$.each(data, function(indexs, items){
		val+='<tr class="collection_detailed"  id="tr'+items.GID+'" >'
            ...
            +'<a href="javascript:void(0)" style="float:left; margin-left:20px; margin-top:43px; color:#2BB8AA;" class="goods_text" onMouseOver="changeFontColor(0)" onMouseOut="returnFontColor(0)">'+items.GTITLE1+'</a>'
            +'</div></td>'
            +'<td><div><p class="goods_text">￥'+items.GPRICE2+'</p></div></td>'
            +'<td><div><p class="goods_text">'+items.CSTATUS+'</p></div></td>'
            +'<td>'
            +'<div>'
            +'<a href="javascript:void(0)" class="goods_text" style="margin-left:23px; color:#2BB8AA;" onMouseOver="changeFontColor(3)" onMouseOut="returnFontColor(3)">购买</a>'
				+'<a href="javascript:void(0)" class="goods_text" style="margin-left:3px;" onMouseOver="changeFontColor(4)" onMouseOut="returnFontColor(4)" onClick="deleteCollection('+items.GID+')">删除</a>'
            +'</div>'
            +'</td>'
            +'</tr>';
	});
...
<body>
        ...
        <ul><!-- 
            ...
            <li id="head_5">
                ...
                <ul>
                    ...
                    <li class="head_5_li"><a href=""><h4>今日新单</a></h4></li>
                    <li class="head_5_li"><a href=""><h4>身边团购</a></h4></li>
                </ul>
           </li><!--head_5-->
       </ul>
    </div><!--head-->
    <div id="content">
       <div id="bw">
       	  <div id="left_nav">
       		 <div id="my_zone" style="border:#eee solid 1px; border-right-color:#f6f6f6; border-left-color:#f6f6f6; border-top-color:#f6f6f6; 
             ">
             	<strong><a href="javascript:void(0)">我的主页</a></strong>
             </div>
             <div id="my_list">
             	<strong>我的订单</strong>
                <ul>
                	<li class="list" onMouseDown="changeColor(0)"><a class="font" onMouseOver="fontColor(0)" onMouseOut="fontReturn(0)" href="javascript:void(0)">团购订单</a><img class="image" /></li>
                    <li class="list" onMouseDown="changeColor(1)"><a class="font" onMouseOver="fontColor(1)" onMouseOut="fontReturn(1)" href="javascript:void(0)">我的收藏</a><img class="image" /></li>
                </ul>
             </div>
             <div id="my_eva" style="border:#eee solid 1px;  border-right-color:#f6f6f6; border-left-color:#f6f6f6">
             	<strong>我的评价</strong>
                <ul>
                	<li class="list" onMouseDown="changeColor(2)"><a class="font" onMouseOver="fontColor(2)" onMouseOut="fontReturn(2)" href="javascript:void(0)">待评价</a><img class="image" /></li>
                    <li class="list" onMouseDown="changeColor(3)"><a class="font" onMouseOver="fontColor(3)" onMouseOut="fontReturn(3)" href="javascript:void(0)">已评价</a><img class="image" /></li>
                </ul>
             </div>
             
             <div id="my_account" style="border:#eee solid 1px;  border-right-color:#f6f6f6; border-left-color:#f6f6f6">
             	<strong>我的账户</strong>
               	<ul>
                	<li class="list" onMouseDown="changeColor(4)"><a class="font" onMouseOver="fontColor(4)" onMouseOut="fontReturn(4)" href="javascript:void(0)">我的积分</a><img class="image" /></li>
                    <li class="list" onMouseDown="changeColor(5)"><a class="font" onMouseOver="fontColor(5)" onMouseOut="fontReturn(5)" href="javascript:void(0)">抵用券</a><img class="image" /></li>
                    <li class="list" onMouseDown="changeColor(6)"><a class="font" onMouseOver="fontColor(6)" onMouseOut="fontReturn(6)" href="javascript:void(0)">我的余额</a><img class="image" /></li>
                    <li class="list" onMouseDown="changeColor(7)"><a class="font" onMouseOver="fontColor(7)" onMouseOut="fontReturn(7)" href="javascript:void(0)">账户设置</a><img class="image" /></li>
                    <li class="list" onMouseDown="changeColor(8)"><a class="font" onMouseOver="fontColor(8)" onMouseOut="fontReturn(8)" href="javascript:void(0)">安全中心</a><img class="image" /></li>
                </ul>
             </div>
          </div>
          <div id="right_view">
			 <div id="v0" class="view">
                ...
                <div class="orders_head">
                	<div class="order_cell_info"><p>团购信息</p></div>
                    <div class="order_cell_number"><p>数量</p></div>
                    <div class="order_cell_price"><p>&nbsp;总价</p></div>
                    <div class="order_cell_statu"><p>订单状态</p></div>
                    <div class="order_cell_operate"><p>操作</p></div>
                </div>
                
                <div class="orders_body">
                	<div class="order_title">              	
                    	订单编号：<a class="number" href="javascript:void(0)">12345678</a>
                        <a class="delete" href="javascript:void(0)" onMouseOver="fc(0)" onMouseOut="fr(0)">删除</a>
                    </div>
                    <div class="order_row">
                    	<div class="order_cell_info">
                        	<div class="images">
                            	<a href="javascript:void(0)"><img src="../images/goods_image_1.jpg" /></a>
                            </div>
                            <div class="goods_info">
                            	<a class="goods" href="javascript:void(0)" onMouseOver="font_1(0)" onMouseOut="fr_1(0)">Theron 希伦蛋糕</a><br />
                                <p>有效期至：2015-12-31</p>
         	 ...
         	 <div id="v1" class="view">       
             	<div class="myFavo">
                	...
                	<ul>
                            <li class="top_nav"><a href="javascript:void(0)" class="nav_content" onMouseOver="navChange(0)" onMouseOut="navReturn(0)" onClick="clicked(0)">&nbsp;全部&nbsp;</a></li>
                            <li class="top_nav"><a href="javascript:void(0)" class="nav_content" onMouseOver="navChange(1)" onMouseOut="navReturn(1)" onClick="clicked(1)">&nbsp;进行中团购&nbsp;</a></li>
                            <li class="top_nav"><a href="javascript:void(0)" class="nav_content" onMouseOver="navChange(2)" onMouseOut="navReturn(2)" onClick="clicked(2)">&nbsp;已结束&nbsp;</a></li>
                        </ul>
                    </div>
                    <div style="border:#EEE 1px solid; width:763px;">
                    	<table cellspacing="0" cellpadding="0" border="0">
						<tr id="collection_list"><th class="item_info" width="491"><p>团购项目</p></th><th width="80"><p>金额</p></th><th width="80"><p>状态</p></th><th width="112"><p>操作</p></th></tr>
                        	<tbody id="info_tbody">
								<tr class="collection_detailed"  id="tr'+items.GID+'" >
									<td><div style="height:100px;">
									<a href="javascript:void(0)"><img srcsrc="../ges/goods_image_1.jpg" style="float:left; margin-top:20px; margin-left:20px; width:100px; height:61px;" /></a>
									<a href="javascript:void(0)" style="float:left; margin-left:20px; margin-top:43px; color:#2BB8AA;" class="goods_text" onMouseOver="changeFontColor(0)" onMouseOut="returnFontColor(0)">DIY蛋糕</a>
									</div></td>
									<td><div><p class="goods_text">￥22</p></div></td>
									<td><div><p class="goods_text">进行中</p></div></td>
									<td>
									<div>
									<a href="javascript:void(0)" class="goods_text" style="margin-left:23px; color:#2BB8AA;" onMouseOver="changeFontColor(3)" onMouseOut="returnFontColor(3)">购买</a>
									<a href="javascript:void(0)" class="goods_text" style="margin-left:3px;" onMouseOver="changeFontColor(4)" onMouseOut="returnFontColor(4)" onClick="deleteCollection('+items.GID+')">删除</a>
             ...
             <div id="v2" class="view">
				<div style="margin-left:164px; margin-top:230px;" id="nullv2">
					...
					<div style="float:left; margin-top:47px; margin-left:15px; color:#666;">
						亲，您没有待评价的订单哦，请移步到<a id="move_index" href="index.html">美团首页</a>下单吧！
					</div>
				</div>
             	<div id="weipingjia">
                	<div id="v2_jifen">
                    	<p>积分规则升级啦！认真评价可获<a class="v2_jf_count">100</a>积分奖励！<a id="v2_guize" href="">积分规则»</a></p>
                        <p>极速评价积分奖励活动已经结束，后续将会推出更多评价送积分活动，敬请期待！</p>
                        <p>您有<a class="v2_jf_count">0</a>个待评价的订单。 现在评价，可随机赢取积分，每单最多可获100积分。</p>
                    </div>
					...
					<li class="pingjiaLi" onclick="add()">
						...
						<form class="pingjiaForm">
							<div>
								...
								<div class="v2_d_img v2_d_div"><img src="../images/goods_image_1.jpg" width="90" height="60"></div>
								<div class="v2_d_pingjia v2_d_div">
								<p><a src="../javascript:void(0)" id="v2_d_title">戏论蛋糕</a><input type="hidden" value="'+item.muid+'" name="muid"></p>
             ...
             <div id="v3" class="view">
            	<div class="v3_content">
                    ...
                    <div class="v3_evaluated v3_">
                    	<p class="v3_gtitle1"><a class="v3_g_goods" href="">非i而恢复i</a></p>
                    	<p class="v3_grade">我的总体评价<a class="v3_g_point"></a>好</p>
