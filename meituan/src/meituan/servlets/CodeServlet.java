...
public class CodeServlet extends HttpServlet {  
	private static final long serialVersionUID = -8629816280461112905L;
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)  
        ...
        char[] ch = "1234567890".toCharArray(); // 随即产生的字符串 不包括 i l(小写L) o（小写O） 1（数字1）0(数字0)   abcdefghjkmnpqrstuvwxyz
